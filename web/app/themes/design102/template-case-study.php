...
<div class="masonry-layout">
    <div class="block block--image">
        <img src="<?= get_template_directory_uri() ?>/dist/images/static/case-study-image-1.jpg">
    </div>
    ...
    <div class="block block--image">
        <img src="<?= get_template_directory_uri() ?>/dist/images/static/case-study-image-2.jpg">
    </div>
    <div class="block block--text">
        <h2>Solution</h2>
